...
const CryptoWidget: React.FC = () => {
  ...
  const [selectedWidget, setSelectedWidget] = useState<WidgetTypes>('Trending Cryptos')
  ...
  return (
    <>
      <div className="col-span-1 hover:scale-105 transition-all rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-lg">
        ...
        <Switcher changeSelectedWidget={setSelectedWidget} widgetSelected={selectedWidget} widgetList={crypto_widgets}/>
