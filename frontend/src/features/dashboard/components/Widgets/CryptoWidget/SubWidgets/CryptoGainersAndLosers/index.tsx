...
const CryptoGainersAndLosers: React.FC = () => {
  ...
  return (
    <div className="rounded-lg py-4 grid grid-cols-2 gap-4 ">
      {data.map((coin: ICryptoTopGainers) => (
        <div
          key={coin.id}
          className="flex items-center hover:bg-gradient-to-r from-gray-50 to-gray-500 hover:scale-105 hover:text-black gap-3 p-2 border dark:border-gray-600 border-gray-200 rounded shadow-sm hover:shadow-md transition"
        >
          <img
            src={coin.image}
