...
const NasaWidget: React.FC = () => {
  ...
  // Apod
  const { apodStatus, neoWsStatus, widgetSelected } = nasa_info;
  ...
  return (
    <div className="relative col-span-1 min-w-20 rounded-2xl bg-gradient-to-br from-gray-200 via-gray-100 to-blue-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-900 p-4 shadow-2xl border border-gray-300 hover:scale-105 transform transition-all duration-300">
      <div>
